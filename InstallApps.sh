...
# INACTIVE ksysguard         - Taskmanager
...
# menulibre         - GUI to edit start menu
sudo apt update
sudo apt install searchmonkey bleachbit duc armitage hardinfo kali-tools-802-11 tilix docker-compose xarchiver johnny menulibre -y
